...
class Message {  // abstract base class
  // protected will allow access to these members by objects of derived class es
 protected:
  string author;
  string subject;
  string body;
  ...
  // This will be the size of the messageList vector to which th e
  // newly constructed Message * is being pushed_bac k
  vector <Message*> childList;  // New!!
  // This is how a Message is able to keep track of its Replie s
 public:
  // default constructor
  Message();

  // Parameterized constructor;
  // id will be the size of current BBoard's messageLis t
   ...
   * indentation == 1, the reply should be indented 2 spaces, i f
